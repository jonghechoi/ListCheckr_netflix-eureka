...
def JAR_FILE = 'netflix-eureka-0.0.1-SNAPSHOT.jar'

def TARGET_DOCKER_CONTAINER = 'netflix-eureka'
def DOCKER_HUB_REGISTRY = 'https://registry.hub.docker.com'
def DOCKER_HUB_USERNAME = 'sosinnmi2'
def DOCKER_HUB_REPOSITORY = 'netflix-eureka'
def PROFILE = 'dev'
...
pipeline {
    ...
    environment {
        GIT_CHECKOUT_URL = 'https://github.com/jonghechoi/netflix-eureka.git'
